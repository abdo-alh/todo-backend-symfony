...
class ListController extends AbstractFOSRestController
{
    ...
    public function backgroundListsAction(Request $request, ParamFetcher $paramFetcher,TaskList $list)
    {
        ...
        //check if file is exists or not : if exists remove it 
        ...
        //if sended file not null upload it in the directory and save the file name and path in DB
        if ($file) {
    ...
    public function putListsAction(int $id)
    {
    }
